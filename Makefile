.PHONY: build-ios test test-ios-unit check-design check-l10n test-onboarding-e2e test-app-e2e test-journey-e2e test-progress-e2e test-coach-e2e record-app-tour
